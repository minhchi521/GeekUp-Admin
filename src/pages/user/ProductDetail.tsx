        ...
        <div className="product-reviews">
          ...
          <div className="reviews-container">
            <div className="review-item">
              ...
              <p className="review-text">Amazing product! Excellent quality and fast delivery.</p>
            </div>
            ...
            <div className="review-item">
              ...
              <p className="review-text">Great product, very satisfied with my purchase. Highly recommended!</p>
            </div>
          </div>
        </div>
      </div>
